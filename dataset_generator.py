...
def random_pattern_params(
    ...
    return PatternParams(
        ...
        gate_center_x_nm=float(
            ...
            + (0.0 if is_array_core else rng.uniform(-160.0, 160.0))
        ),
        gate_length_nm=20_000.0 if is_array_core else float(rng.uniform(360.0, 760.0)),
...
def generate_pair(
    ...
    pattern_params = random_pattern_params(seed + 10_000, ref_center_nm, is_array_core)
